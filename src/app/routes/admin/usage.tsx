...
function BusinessRow({ s }: { s: AdminUsage }) {
  return (
...
function GrowthRow({ s }: { s: AdminUsage }) {
  return (
...
function TopListsRow({ s }: { s: AdminUsage }) {
  return (
    <div className="mt-4 grid gap-4 lg:grid-cols-2">
      <Card>
        <p className="mb-3 text-2xs tracking-wider text-muted uppercase">
...
function TableSizeCard({ s }: { s: AdminUsage }) {
  const projectedDate =
...
function HealthRow({ s }: { s: AdminUsage }) {
  return (
    <div className="mt-4 grid gap-4 lg:grid-cols-2">
      <Card>
        <p className="mb-3 text-2xs tracking-wider text-muted uppercase">
